# Known limitations — HyperIso 1.0.0
...
- Analytical methods of `LikelihoodMarginal` (`logpdf`, derivatives, CDF, inverse
  CDF, mean and standard deviation) are not defined in 1.0.0. The class is a
...
The 1.0.0 Python binary release targets Linux x86-64 with CPython 3.10–3.12.
macOS, Windows, PyPy and musllinux are not release targets for 1.0.0.
