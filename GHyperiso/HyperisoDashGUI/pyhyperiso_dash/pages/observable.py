        ...
        children=[
            field(
                ...
                dropdown(
                    ...
                    value=svc.default_parameter_type_name("SM"),
                ),
            ),
            field(
                "Block",
    ...
    return html.Div(
        [
            field(
                "Expert controls",
                dcc.Checklist(
                    id=f"{prefix}-advanced-mode",
                    options=[
                        {
                            "label": "show decay configuration controls",
                            "value": "advanced",
                        }
                    ],
                    value=[],
            ...
            html.Div(
                id=f"{prefix}-expert-panel",
                style={"display": "none"},
                children=[
                    small_note(
                        "Decay configuration is applied to the shared ObservableInterface before computations. Use it for form-factor sources, lepton generation, charges and thread hints when supported by the selected decay.",
                        tone="info",
                    ),
                    field(
                        "Decay configuration target",
                        dropdown(
                            f"{prefix}-decay-config-decay",
                            svc.decay_options(),
                            value="B__l_l",
                            multi=False,
                        ),
                    ...
                    html.Div(
                        ...
                        children=[
                            html.Button(
                                ...
                                id=f"{prefix}-apply-decay-config-btn",
                                n_clicks=0,
                            ),
                        ],
                    ),
                    status_box(
                        f"{prefix}-decay-config-status",
    ...
    return html.Div(
        children=[
            page_title(
                ...
                "Select a decay first, then observables from that decay, compute predictions, and scan parameter dependence.",
                "Observable",
            ),
            html.Div(
                className="page-grid",
                children=[
                    html.Div(
                        ...
                        children=[
                            ...
                            card(
                                "Compute",
                                "current registered observables",
                                html.Div(
                                    [
                                        html.Button(
                                        ...
                                        status_box(
                                            "obs-compute-status", "No computation yet."
                                        ),
                                    ]
                                ),
                            ),
                            card(
                                "Parameter scan",
                                "temporary parameter mutation + restore",
                                html.Div(
                                    [
                                        field(
                                            "Plot dimension",
                                            dropdown(
                                                "obs-scan-dim", DIM_OPTIONS, value="1d"
                                            ),
                                        ),
                                        field(
                                            "Decay",
                                        ...
                                        field(
                                            "Observable in selected decay",
                                            dropdown(
                                                "obs-scan-observable",
                                                svc.observable_options_for_decays(
                                                    ["B__l_l"]
                                                ),
                                                value="BR_BS_MUMU",
                                            ),
                                        ...
                                        field(
                                            ...
                                            dcc.Checklist(
                                                ...
                                                options=[
                                                    {
                                                        "label": "apply bin to scanned observable",
                                                        "value": "bin",
                                                    }
                                                ],
                                                value=[],
                                        ...
                                        html.Div(
                                            id="obs-scan-bin-wrap",
                                            style={"display": "none"},
                                            className="form-grid-2",
                                            children=[
                                                field(
                                                    "Bin low",
                                                    num_input("obs-scan-bin-low", 1.0),
                                                ),
                                                field(
                                                    "Bin high",
                                                    num_input("obs-scan-bin-high", 6.0),
                                                ),
                                            ],
                                        ),
                                        html.Div(
                                            ...
                                            children=[
                                                field(
                                                    "x min", num_input("obs-x-min", 0.0)
                                                ),
                                                field(
                                                    "x max",
                                                    num_input("obs-x-max", 200.0),
                                                ),
                                                field(
                                                    "x points", num_input("obs-x-n", 35)
                                                ),
                                            ],
                                        ),
                                        html.Div(
                                        ...
                                        html.Div(
                                            ...
                                            children=[
                                                field(
                                                    "y min", num_input("obs-y-min", 0.0)
                                                ),
                                                field(
                                                    "y max",
                                                    num_input("obs-y-max", 200.0),
                                                ),
                                                field(
                                                    "y points", num_input("obs-y-n", 20)
                                                ),
                                            ],
                                        ),
                                        html.Div(
                        ...
                        children=[
                            card(
                                ...
                                data_table(
                                    "obs-selection-table",
                                    OBS_SELECTION_COLUMNS,
                                    data=svc.current_observable_rows(),
                                    page_size=12,
                            ...
                            card(
                                ...
                                "compute output",
                                data_table(
                                    "obs-result-table", OBS_RESULT_COLUMNS, page_size=16
                                ),
                            ),
                            card(
                                "Observable scan plot",
                                "1D scatter or 2D heatmap",
                                graph("obs-scan-fig", height=500),
                                className="card graph-card",
                            ),
                            small_note(
                                "LaTeX labels are shown in the main columns; raw enum/block/code values are kept in companion columns for traceability."
                            ),
                        ],
                    ),
                ],
