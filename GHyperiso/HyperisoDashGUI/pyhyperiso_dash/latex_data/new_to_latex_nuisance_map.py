...
NEW_TO_LATEX_NUISANCE_MAP: Dict[NewTarget, str] = {
    ...
    (
        "B_Xsll",
        "3_15_0",
    ): r"$\mathrm{BR}(B\to X_s \tau^+\tau^-)_{\mathrm{low}\ q^2}^{\mathrm{rand}}$",  # BRBXstautau_lowq2_rand
    (
        "B_Xsll",
        "3_15_1",
    ): r"$\mathrm{BR}(B\to X_s \tau^+\tau^-)_{\mathrm{high}\ q^2}^{\mathrm{rand}}$",  # BRBXstautau_highq2_rand
    (
        "B_Xsll",
        "3_15_2",
    ): r"$\mathrm{BR}(B\to X_s \tau^+\tau^-)_{\mathrm{full}}^{\mathrm{rand}}$",  # BRBXstautau_full_rand
    (
        "B_Xsll",
        "3_13_0",
    ): r"$\mathrm{BR}(B\to X_s \mu^+\mu^-)_{\mathrm{low}\ q^2}^{\mathrm{rand}}$",  # BRBXsmumu_lowq2_rand
    (
        "B_Xsll",
        "3_13_1",
    ): r"$\mathrm{BR}(B\to X_s \mu^+\mu^-)_{\mathrm{high}\ q^2}^{\mathrm{rand}}$",  # BRBXsmumu_highq2_rand
    (
        "B_Xsll",
        "3_13_2",
    ): r"$\mathrm{BR}(B\to X_s \mu^+\mu^-)_{\mathrm{full}}^{\mathrm{rand}}$",  # BRBXsmumu_full_rand
    (
        "B_Xsll",
        "3_11_0",
    ): r"$\mathrm{BR}(B\to X_s e^+e^-)_{\mathrm{low}\ q^2}^{\mathrm{rand}}$",  # BRBXsee_lowq2_rand
    (
        "B_Xsll",
        "3_11_1",
    ): r"$\mathrm{BR}(B\to X_s e^+e^-)_{\mathrm{high}\ q^2}^{\mathrm{rand}}$",  # BRBXsee_highq2_rand
    (
        "B_Xsll",
        "3_11_2",
    ): r"$\mathrm{BR}(B\to X_s e^+e^-)_{\mathrm{full}}^{\mathrm{rand}}$",  # BRBXsee_full_rand
    ...
    (
        "B_Ks",
        "2_1_0",
    ): r"$a_{0}^{A_0}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a0A0_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_1_1",
    ): r"$a_{1}^{A_0}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a1A0_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_1_2",
    ): r"$a_{2}^{A_0}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a2A0_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_2_0",
    ): r"$a_{0}^{A_1}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a0A1_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_2_1",
    ): r"$a_{1}^{A_1}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a1A1_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_2_2",
    ): r"$a_{2}^{A_1}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a2A1_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_3_0",
    ): r"$a_{0}^{A_{12}}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a0A12_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_3_1",
    ): r"$a_{1}^{A_{12}}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a1A12_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_3_2",
    ): r"$a_{2}^{A_{12}}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a2A12_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_4_0",
    ): r"$a_{0}^{V}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a0V_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_4_1",
    ): r"$a_{1}^{V}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a1V_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_4_2",
    ): r"$a_{2}^{V}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a2V_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_5_0",
    ): r"$a_{0}^{T_1}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a0T1_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_5_1",
    ): r"$a_{1}^{T_1}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a1T1_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_5_2",
    ): r"$a_{2}^{T_1}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a2T1_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_6_0",
    ): r"$a_{0}^{T_2}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a0T2_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_6_1",
    ): r"$a_{1}^{T_2}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a1T2_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_6_2",
    ): r"$a_{2}^{T_2}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a2T2_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_7_0",
    ): r"$a_{0}^{T_{23}}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a0T23_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_7_1",
    ): r"$a_{1}^{T_{23}}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a1T23_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "2_7_2",
    ): r"$a_{2}^{T_{23}}(B\to K^*)_{\mathrm{BSZ,LCSR-only}}$",  # a2T23_BKstar_BSZ_LCSRonly
    (
        "B_Ks",
        "3_1_0",
    ): r"$a_{0}^{A_0}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a0A0_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_1_1",
    ): r"$a_{1}^{A_0}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a1A0_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_1_2",
    ): r"$a_{2}^{A_0}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a2A0_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_2_0",
    ): r"$a_{0}^{A_1}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a0A1_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_2_1",
    ): r"$a_{1}^{A_1}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a1A1_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_2_2",
    ): r"$a_{2}^{A_1}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a2A1_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_3_0",
    ): r"$a_{0}^{A_{12}}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a0A12_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_3_1",
    ): r"$a_{1}^{A_{12}}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a1A12_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_3_2",
    ): r"$a_{2}^{A_{12}}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a2A12_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_4_0",
    ): r"$a_{0}^{V}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a0V_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_4_1",
    ): r"$a_{1}^{V}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a1V_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_4_2",
    ): r"$a_{2}^{V}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a2V_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_5_0",
    ): r"$a_{0}^{T_1}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a0T1_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_5_1",
    ): r"$a_{1}^{T_1}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a1T1_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_5_2",
    ): r"$a_{2}^{T_1}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a2T1_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_6_0",
    ): r"$a_{0}^{T_2}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a0T2_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_6_1",
    ): r"$a_{1}^{T_2}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a1T2_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_6_2",
    ): r"$a_{2}^{T_2}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a2T2_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_7_0",
    ): r"$a_{0}^{T_{23}}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a0T23_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_7_1",
    ): r"$a_{1}^{T_{23}}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a1T23_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "3_7_2",
    ): r"$a_{2}^{T_{23}}(B\to K^*)_{\mathrm{GRvDV,BSZ}}$",  # a2T23_BKstar_GRvDV_BSZ
    (
        "B_Ks",
        "4_1_0",
    ): r"$a_{0}^{A_0}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a0A0_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_1_1",
    ): r"$a_{1}^{A_0}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1A0_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_1_2",
    ): r"$a_{2}^{A_0}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2A0_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_2_0",
    ): r"$a_{0}^{A_1}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a0A1_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_2_1",
    ): r"$a_{1}^{A_1}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1A1_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_2_2",
    ): r"$a_{2}^{A_1}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2A1_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_3_0",
    ): r"$a_{0}^{A_{12}}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a0A12_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_3_1",
    ): r"$a_{1}^{A_{12}}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1A12_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_3_2",
    ): r"$a_{2}^{A_{12}}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2A12_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_4_0",
    ): r"$a_{0}^{V}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a0V_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_4_1",
    ): r"$a_{1}^{V}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1V_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_4_2",
    ): r"$a_{2}^{V}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2V_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_5_0",
    ): r"$a_{0}^{T_1}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a0T1_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_5_1",
    ): r"$a_{1}^{T_1}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1T1_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_5_2",
    ): r"$a_{2}^{T_1}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2T1_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_6_0",
    ): r"$a_{0}^{T_2}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a0T2_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_6_1",
    ): r"$a_{1}^{T_2}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1T2_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_6_2",
    ): r"$a_{2}^{T_2}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2T2_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_7_0",
    ): r"$a_{0}^{T_{23}}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a0T23_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_7_1",
    ): r"$a_{1}^{T_{23}}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1T23_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "4_7_2",
    ): r"$a_{2}^{T_{23}}(B\to K^*)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2T23_BKstar_GKvD_LCSR_Lattice
    (
        "B_Ks",
        "5_1_0",
    ): r"$a_{0}^{A_0}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a0A0_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_1_1",
    ): r"$a_{1}^{A_0}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a1A0_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_1_2",
    ): r"$a_{2}^{A_0}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a2A0_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_2_0",
    ): r"$a_{0}^{A_1}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a0A1_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_2_1",
    ): r"$a_{1}^{A_1}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a1A1_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_2_2",
    ): r"$a_{2}^{A_1}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a2A1_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_3_0",
    ): r"$a_{0}^{A_{12}}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a0A12_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_3_1",
    ): r"$a_{1}^{A_{12}}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a1A12_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_3_2",
    ): r"$a_{2}^{A_{12}}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a2A12_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_4_0",
    ): r"$a_{0}^{V}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a0V_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_4_1",
    ): r"$a_{1}^{V}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a1V_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_4_2",
    ): r"$a_{2}^{V}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a2V_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_5_0",
    ): r"$a_{0}^{T_1}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a0T1_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_5_1",
    ): r"$a_{1}^{T_1}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a1T1_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_5_2",
    ): r"$a_{2}^{T_1}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a2T1_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_6_0",
    ): r"$a_{0}^{T_2}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a0T2_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_6_1",
    ): r"$a_{1}^{T_2}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a1T2_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_6_2",
    ): r"$a_{2}^{T_2}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a2T2_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_7_0",
    ): r"$a_{0}^{T_{23}}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a0T23_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_7_1",
    ): r"$a_{1}^{T_{23}}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a1T23_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "5_7_2",
    ): r"$a_{2}^{T_{23}}(B\to K^*)_{\mathrm{GKvD,LCSR-only}}$",  # a2T23_BKstar_GKvD_LCSRonly
    (
        "B_Ks",
        "6",
    ): r"$\sigma_{\mathrm{syst}}(B\to K^*)_{\mathrm{HLMW}}$",  # systErr_BKstar_HLMW
    ...
    (
        "B_Ks",
        "6_3_0",
    ): r"$a_{0}^{A_{12}}(B\to K^*)_{\mathrm{HLMW}}$",  # a0A12_BKstar_HLMW
    (
        "B_Ks",
        "6_3_1",
    ): r"$a_{1}^{A_{12}}(B\to K^*)_{\mathrm{HLMW}}$",  # a1A12_BKstar_HLMW
    ...
    (
        "B_Ks",
        "6_7_0",
    ): r"$a_{0}^{T_{23}}(B\to K^*)_{\mathrm{HLMW}}$",  # a0T23_BKstar_HLMW
    (
        "B_Ks",
        "6_7_1",
    ): r"$a_{1}^{T_{23}}(B\to K^*)_{\mathrm{HLMW}}$",  # a1T23_BKstar_HLMW
    ...
    (
        "B_K",
        "1_1_0",
    ): r"$a_{0}^{f_+}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a0fp_BK_AS_LCSR_Lattice
    (
        "B_K",
        "1_1_1",
    ): r"$a_{1}^{f_+}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a1fp_BK_AS_LCSR_Lattice
    (
        "B_K",
        "1_1_2",
    ): r"$a_{2}^{f_+}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a2fp_BK_AS_LCSR_Lattice
    (
        "B_K",
        "1_2_0",
    ): r"$a_{0}^{f_0}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a0f0_BK_AS_LCSR_Lattice
    (
        "B_K",
        "1_2_1",
    ): r"$a_{1}^{f_0}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a1f0_BK_AS_LCSR_Lattice
    (
        "B_K",
        "1_2_2",
    ): r"$a_{2}^{f_0}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a2f0_BK_AS_LCSR_Lattice
    (
        "B_K",
        "1_2_3",
    ): r"$a_{3}^{f_0}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a3f0_BK_AS_LCSR_Lattice
    (
        "B_K",
        "1_3_0",
    ): r"$a_{0}^{f_T}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a0fT_BK_AS_LCSR_Lattice
    (
        "B_K",
        "1_3_1",
    ): r"$a_{1}^{f_T}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a1fT_BK_AS_LCSR_Lattice
    (
        "B_K",
        "1_3_2",
    ): r"$a_{2}^{f_T}(B\to K)_{\mathrm{AS,LCSR+Lattice}}$",  # a2fT_BK_AS_LCSR_Lattice
    (
        "B_K",
        "2_1_0",
    ): r"$a_{0}^{f_+}(B\to K)_{\mathrm{GRvDV,BSZ}}$",  # a0fp_BK_GRvDV_BSZ
    (
        "B_K",
        "2_1_1",
    ): r"$a_{1}^{f_+}(B\to K)_{\mathrm{GRvDV,BSZ}}$",  # a1fp_BK_GRvDV_BSZ
    (
        "B_K",
        "2_1_2",
    ): r"$a_{2}^{f_+}(B\to K)_{\mathrm{GRvDV,BSZ}}$",  # a2fp_BK_GRvDV_BSZ
    (
        "B_K",
        "2_2_1",
    ): r"$a_{1}^{f_0}(B\to K)_{\mathrm{GRvDV,BSZ}}$",  # a1f0_BK_GRvDV_BSZ
    (
        "B_K",
        "2_2_2",
    ): r"$a_{2}^{f_0}(B\to K)_{\mathrm{GRvDV,BSZ}}$",  # a2f0_BK_GRvDV_BSZ
    (
        "B_K",
        "2_3_0",
    ): r"$a_{0}^{f_T}(B\to K)_{\mathrm{GRvDV,BSZ}}$",  # a0fT_BK_GRvDV_BSZ
    (
        "B_K",
        "2_3_1",
    ): r"$a_{1}^{f_T}(B\to K)_{\mathrm{GRvDV,BSZ}}$",  # a1fT_BK_GRvDV_BSZ
    (
        "B_K",
        "2_3_2",
    ): r"$a_{2}^{f_T}(B\to K)_{\mathrm{GRvDV,BSZ}}$",  # a2fT_BK_GRvDV_BSZ
    (
        "B_K",
        "3_1_0",
    ): r"$a_{0}^{f_+}(B\to K)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a0fp_BK_GKvD_LCSR_Lattice
    (
        "B_K",
        "3_1_1",
    ): r"$a_{1}^{f_+}(B\to K)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1fp_BK_GKvD_LCSR_Lattice
    (
        "B_K",
        "3_1_2",
    ): r"$a_{2}^{f_+}(B\to K)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2fp_BK_GKvD_LCSR_Lattice
    (
        "B_K",
        "3_2_1",
    ): r"$a_{1}^{f_0}(B\to K)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1f0_BK_GKvD_LCSR_Lattice
    (
        "B_K",
        "3_2_2",
    ): r"$a_{2}^{f_0}(B\to K)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2f0_BK_GKvD_LCSR_Lattice
    (
        "B_K",
        "3_3_0",
    ): r"$a_{0}^{f_T}(B\to K)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a0fT_BK_GKvD_LCSR_Lattice
    (
        "B_K",
        "3_3_1",
    ): r"$a_{1}^{f_T}(B\to K)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a1fT_BK_GKvD_LCSR_Lattice
    (
        "B_K",
        "3_3_2",
    ): r"$a_{2}^{f_T}(B\to K)_{\mathrm{GKvD,LCSR+Lattice}}$",  # a2fT_BK_GKvD_LCSR_Lattice
    (
        "B_K",
        "4_1_0",
    ): r"$a_{0}^{f_+}(B\to K)_{\mathrm{GKvD,LCSR-only}}$",  # a0fp_BK_GKvD_LCSRonly
    (
        "B_K",
        "4_1_1",
    ): r"$a_{1}^{f_+}(B\to K)_{\mathrm{GKvD,LCSR-only}}$",  # a1fp_BK_GKvD_LCSRonly
    (
        "B_K",
        "4_1_2",
    ): r"$a_{2}^{f_+}(B\to K)_{\mathrm{GKvD,LCSR-only}}$",  # a2fp_BK_GKvD_LCSRonly
    (
        "B_K",
        "4_2_1",
    ): r"$a_{1}^{f_0}(B\to K)_{\mathrm{GKvD,LCSR-only}}$",  # a1f0_BK_GKvD_LCSRonly
    (
        "B_K",
        "4_2_2",
    ): r"$a_{2}^{f_0}(B\to K)_{\mathrm{GKvD,LCSR-only}}$",  # a2f0_BK_GKvD_LCSRonly
    (
        "B_K",
        "4_3_0",
    ): r"$a_{0}^{f_T}(B\to K)_{\mathrm{GKvD,LCSR-only}}$",  # a0fT_BK_GKvD_LCSRonly
    (
        "B_K",
        "4_3_1",
    ): r"$a_{1}^{f_T}(B\to K)_{\mathrm{GKvD,LCSR-only}}$",  # a1fT_BK_GKvD_LCSRonly
    (
        "B_K",
        "4_3_2",
    ): r"$a_{2}^{f_T}(B\to K)_{\mathrm{GKvD,LCSR-only}}$",  # a2fT_BK_GKvD_LCSRonly
    ...
    (
        "B_phi",
        "2_1_0",
    ): r"$a_{0}^{A_0}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a0A0_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_1_1",
    ): r"$a_{1}^{A_0}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a1A0_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_1_2",
    ): r"$a_{2}^{A_0}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a2A0_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_2_0",
    ): r"$a_{0}^{A_1}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a0A1_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_2_1",
    ): r"$a_{1}^{A_1}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a1A1_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_2_2",
    ): r"$a_{2}^{A_1}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a2A1_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_3_0",
    ): r"$a_{0}^{A_{12}}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a0A12_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_3_1",
    ): r"$a_{1}^{A_{12}}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a1A12_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_3_2",
    ): r"$a_{2}^{A_{12}}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a2A12_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_4_0",
    ): r"$a_{0}^{V}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a0V_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_4_1",
    ): r"$a_{1}^{V}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a1V_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_4_2",
    ): r"$a_{2}^{V}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a2V_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_5_0",
    ): r"$a_{0}^{T_1}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a0T1_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_5_1",
    ): r"$a_{1}^{T_1}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a1T1_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_5_2",
    ): r"$a_{2}^{T_1}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a2T1_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_6_0",
    ): r"$a_{0}^{T_2}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a0T2_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_6_1",
    ): r"$a_{1}^{T_2}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a1T2_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_6_2",
    ): r"$a_{2}^{T_2}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a2T2_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_7_0",
    ): r"$a_{0}^{T_{23}}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a0T23_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_7_1",
    ): r"$a_{1}^{T_{23}}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a1T23_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "2_7_2",
    ): r"$a_{2}^{T_{23}}(B_s\to\phi)_{\mathrm{BSZ,LCSR-only}}$",  # a2T23_Bsphi_BSZ_LCSRonly
    (
        "B_phi",
        "3_1_0",
    ): r"$a_{0}^{A_0}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a0A0_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_1_1",
    ): r"$a_{1}^{A_0}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a1A0_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_1_2",
    ): r"$a_{2}^{A_0}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a2A0_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_2_0",
    ): r"$a_{0}^{A_1}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a0A1_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_2_1",
    ): r"$a_{1}^{A_1}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a1A1_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_2_2",
    ): r"$a_{2}^{A_1}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a2A1_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_3_0",
    ): r"$a_{0}^{A_{12}}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a0A12_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_3_1",
    ): r"$a_{1}^{A_{12}}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a1A12_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_3_2",
    ): r"$a_{2}^{A_{12}}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a2A12_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_4_0",
    ): r"$a_{0}^{V}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a0V_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_4_1",
    ): r"$a_{1}^{V}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a1V_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_4_2",
    ): r"$a_{2}^{V}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a2V_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_5_0",
    ): r"$a_{0}^{T_1}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a0T1_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_5_1",
    ): r"$a_{1}^{T_1}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a1T1_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_5_2",
    ): r"$a_{2}^{T_1}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a2T1_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_6_0",
    ): r"$a_{0}^{T_2}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a0T2_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_6_1",
    ): r"$a_{1}^{T_2}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a1T2_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_6_2",
    ): r"$a_{2}^{T_2}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a2T2_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_7_0",
    ): r"$a_{0}^{T_{23}}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a0T23_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_7_1",
    ): r"$a_{1}^{T_{23}}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a1T23_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "3_7_2",
    ): r"$a_{2}^{T_{23}}(B_s\to\phi)_{\mathrm{GRvDV,BSZ}}$",  # a2T23_Bsphi_GRvDV_BSZ
    (
        "B_phi",
        "6",
    ): r"$\sigma_{\mathrm{syst}}(B_s\to\phi)_{\mathrm{HLMW}}$",  # systErr_Bsphi_HLMW
    ...
    (
        "B_phi",
        "6_3_0",
    ): r"$a_{0}^{A_{12}}(B_s\to\phi)_{\mathrm{HLMW}}$",  # a0A12_Bsphi_HLMW
    (
        "B_phi",
        "6_3_1",
    ): r"$a_{1}^{A_{12}}(B_s\to\phi)_{\mathrm{HLMW}}$",  # a1A12_Bsphi_HLMW
    ...
    (
        "B_phi",
        "6_7_0",
    ): r"$a_{0}^{T_{23}}(B_s\to\phi)_{\mathrm{HLMW}}$",  # a0T23_Bsphi_HLMW
    (
        "B_phi",
        "6_7_1",
    ): r"$a_{1}^{T_{23}}(B_s\to\phi)_{\mathrm{HLMW}}$",  # a1T23_Bsphi_HLMW
    ("FLIFE", "5122"): r"$\tau_{\Lambda_b}$",  # life_Lb
    ("Lb_L", "8"): r"$\alpha_{\Lambda}(\Lambda_b\to\Lambda\ell\ell)$",  # alphaL_LbLll
    (
        "Lb_L",
        "1_1_0",
    ): r"$a_{0}^{f_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a0_HO_fperp_LbLll
    (
        "Lb_L",
        "1_1_1",
    ): r"$a_{1}^{f_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a1_HO_fperp_LbLll
    (
        "Lb_L",
        "1_1_2",
    ): r"$a_{2}^{f_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a2_HO_fperp_LbLll
    (
        "Lb_L",
        "1_2_0",
    ): r"$a_{0}^{h_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a0_HO_hperp_LbLll
    (
        "Lb_L",
        "1_2_1",
    ): r"$a_{1}^{h_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a1_HO_hperp_LbLll
    (
        "Lb_L",
        "1_2_2",
    ): r"$a_{2}^{h_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a2_HO_hperp_LbLll
    (
        "Lb_L",
        "1_3_1",
    ): r"$a_{1}^{g_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a1_HO_gperp_LbLll
    (
        "Lb_L",
        "1_3_2",
    ): r"$a_{2}^{g_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a2_HO_gperp_LbLll
    (
        "Lb_L",
        "1_4_0",
    ): r"$a_{0}^{f_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a0_HO_fplus_LbLll
    (
        "Lb_L",
        "1_4_1",
    ): r"$a_{1}^{f_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a1_HO_fplus_LbLll
    (
        "Lb_L",
        "1_4_2",
    ): r"$a_{2}^{f_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a2_HO_fplus_LbLll
    (
        "Lb_L",
        "1_5_0",
    ): r"$a_{0}^{h_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a0_HO_hplus_LbLll
    (
        "Lb_L",
        "1_5_1",
    ): r"$a_{1}^{h_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a1_HO_hplus_LbLll
    (
        "Lb_L",
        "1_5_2",
    ): r"$a_{2}^{h_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a2_HO_hplus_LbLll
    (
        "Lb_L",
        "1_6_1",
    ): r"$a_{1}^{g_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a1_HO_gplus_LbLll
    (
        "Lb_L",
        "1_6_2",
    ): r"$a_{2}^{g_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a2_HO_gplus_LbLll
    (
        "Lb_L",
        "1_7_1",
    ): r"$a_{1}^{\tilde h_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a1_HO_htildeperp_LbLll
    (
        "Lb_L",
        "1_7_2",
    ): r"$a_{2}^{\tilde h_\perp}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a2_HO_htildeperp_LbLll
    (
        "Lb_L",
        "1_8_1",
    ): r"$a_{1}^{\tilde h_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a1_HO_htildeplus_LbLll
    (
        "Lb_L",
        "1_8_2",
    ): r"$a_{2}^{\tilde h_+}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a2_HO_htildeplus_LbLll
    (
        "K_ll",
        "1",
    ): r"$\mathrm{BR}(K_L\to\gamma\gamma)_{\mathrm{exp}}$",  # BR_KLgammagamma_exp
    (
        "K_ll",
        "2",
    ): r"$\mathrm{BR}(K_S\to\gamma\gamma)_{\mathrm{exp}}$",  # BR_KSgammagamma_exp
    (
        "B_Ks",
        "18_1_1",
    ): r"$\delta A_L^\perp(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKstarlow_ALperp_err_noq2
    (
        "B_Ks",
        "18_1_2",
    ): r"$\delta A_R^\perp(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKstarlow_ARperp_err_noq2
    (
        "B_Ks",
        "18_1_3",
    ): r"$\delta A_L^\parallel(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKstarlow_ALpar_err_noq2
    (
        "B_Ks",
        "18_1_4",
    ): r"$\delta A_R^\parallel(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKstarlow_ARpar_err_noq2
    (
        "B_Ks",
        "18_1_5",
    ): r"$\delta A_L^0(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKstarlow_AL0_err_noq2
    (
        "B_Ks",
        "18_1_6",
    ): r"$\delta A_R^0(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKstarlow_AR0_err_noq2
    (
        "B_Ks",
        "18_1_7",
    ): r"$\delta A_t(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKstarlow_At_err_noq2
    (
        "B_Ks",
        "18_1_8",
    ): r"$\delta A_S(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKstarlow_AS_err_noq2
    (
        "B_Ks",
        "18_2_1",
    ): r"$\delta A_L^\perp(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKstarlow_ALperp_err_q2
    (
        "B_Ks",
        "18_2_2",
    ): r"$\delta A_R^\perp(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKstarlow_ARperp_err_q2
    (
        "B_Ks",
        "18_2_3",
    ): r"$\delta A_L^\parallel(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKstarlow_ALpar_err_q2
    (
        "B_Ks",
        "18_2_4",
    ): r"$\delta A_R^\parallel(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKstarlow_ARpar_err_q2
    (
        "B_Ks",
        "18_2_5",
    ): r"$\delta A_L^0(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKstarlow_AL0_err_q2
    (
        "B_Ks",
        "18_2_6",
    ): r"$\delta A_R^0(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKstarlow_AR0_err_q2
    (
        "B_Ks",
        "18_2_7",
    ): r"$\delta A_t(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKstarlow_At_err_q2
    (
        "B_Ks",
        "18_2_8",
    ): r"$\delta A_S(B\to K^*)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKstarlow_AS_err_q2
    (
        "B_Ks",
        "18_3_1",
    ): r"$\delta A_L^\perp(B\to K^*)_{\mathrm{high}}$",  # BtoKstarhigh_ALperp_err
    (
        "B_Ks",
        "18_3_2",
    ): r"$\delta A_R^\perp(B\to K^*)_{\mathrm{high}}$",  # BtoKstarhigh_ARperp_err
    (
        "B_Ks",
        "18_3_3",
    ): r"$\delta A_L^\parallel(B\to K^*)_{\mathrm{high}}$",  # BtoKstarhigh_ALpar_err
    (
        "B_Ks",
        "18_3_4",
    ): r"$\delta A_R^\parallel(B\to K^*)_{\mathrm{high}}$",  # BtoKstarhigh_ARpar_err
    (
        "B_Ks",
        "18_3_5",
    ): r"$\delta A_L^0(B\to K^*)_{\mathrm{high}}$",  # BtoKstarhigh_AL0_err
    (
        "B_Ks",
        "18_3_6",
    ): r"$\delta A_R^0(B\to K^*)_{\mathrm{high}}$",  # BtoKstarhigh_AR0_err
    (
        "B_Ks",
        "18_3_7",
    ): r"$\delta A_t(B\to K^*)_{\mathrm{high}}$",  # BtoKstarhigh_At_err
    (
        "B_Ks",
        "18_3_8",
    ): r"$\delta A_S(B\to K^*)_{\mathrm{high}}$",  # BtoKstarhigh_AS_err
    (
        "B_K",
        "18_1_1",
    ): r"$\delta F_V(B\to K)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKlow_FV_err_noq2
    (
        "B_K",
        "18_1_2",
    ): r"$\delta F_A(B\to K)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKlow_FA_err_noq2
    (
        "B_K",
        "18_1_3",
    ): r"$\delta F_S(B\to K)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKlow_FS_err_noq2
    (
        "B_K",
        "18_1_4",
    ): r"$\delta F_P(B\to K)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # BtoKlow_FP_err_noq2
    (
        "B_K",
        "18_2_1",
    ): r"$\delta F_V(B\to K)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKlow_FV_err_q2
    (
        "B_K",
        "18_2_2",
    ): r"$\delta F_A(B\to K)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKlow_FA_err_q2
    (
        "B_K",
        "18_2_3",
    ): r"$\delta F_S(B\to K)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKlow_FS_err_q2
    (
        "B_K",
        "18_2_4",
    ): r"$\delta F_P(B\to K)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # BtoKlow_FP_err_q2
    ...
    (
        "B_phi",
        "18_1_1",
    ): r"$\delta A_L^\perp(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # Bstophilow_ALperp_err_noq2
    (
        "B_phi",
        "18_1_2",
    ): r"$\delta A_R^\perp(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # Bstophilow_ARperp_err_noq2
    (
        "B_phi",
        "18_1_3",
    ): r"$\delta A_L^\parallel(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # Bstophilow_ALpar_err_noq2
    (
        "B_phi",
        "18_1_4",
    ): r"$\delta A_R^\parallel(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # Bstophilow_ARpar_err_noq2
    (
        "B_phi",
        "18_1_5",
    ): r"$\delta A_L^0(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # Bstophilow_AL0_err_noq2
    (
        "B_phi",
        "18_1_6",
    ): r"$\delta A_R^0(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # Bstophilow_AR0_err_noq2
    (
        "B_phi",
        "18_1_7",
    ): r"$\delta A_t(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # Bstophilow_At_err_noq2
    (
        "B_phi",
        "18_1_8",
    ): r"$\delta A_S(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-indep}}$",  # Bstophilow_AS_err_noq2
    (
        "B_phi",
        "18_2_1",
    ): r"$\delta A_L^\perp(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # Bstophilow_ALperp_err_q2
    (
        "B_phi",
        "18_2_2",
    ): r"$\delta A_R^\perp(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # Bstophilow_ARperp_err_q2
    (
        "B_phi",
        "18_2_3",
    ): r"$\delta A_L^\parallel(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # Bstophilow_ALpar_err_q2
    (
        "B_phi",
        "18_2_4",
    ): r"$\delta A_R^\parallel(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # Bstophilow_ARpar_err_q2
    (
        "B_phi",
        "18_2_5",
    ): r"$\delta A_L^0(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # Bstophilow_AL0_err_q2
    (
        "B_phi",
        "18_2_6",
    ): r"$\delta A_R^0(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # Bstophilow_AR0_err_q2
    (
        "B_phi",
        "18_2_7",
    ): r"$\delta A_t(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # Bstophilow_At_err_q2
    (
        "B_phi",
        "18_2_8",
    ): r"$\delta A_S(B_s\to\phi)_{\mathrm{low},\ q^2\mathrm{-dep}}$",  # Bstophilow_AS_err_q2
    (
        "B_phi",
        "18_3_1",
    ): r"$\delta A_L^\perp(B_s\to\phi)_{\mathrm{high}}$",  # Bstophihigh_ALperp_err
    (
        "B_phi",
        "18_3_2",
    ): r"$\delta A_R^\perp(B_s\to\phi)_{\mathrm{high}}$",  # Bstophihigh_ARperp_err
    (
        "B_phi",
        "18_3_3",
    ): r"$\delta A_L^\parallel(B_s\to\phi)_{\mathrm{high}}$",  # Bstophihigh_ALpar_err
    (
        "B_phi",
        "18_3_4",
    ): r"$\delta A_R^\parallel(B_s\to\phi)_{\mathrm{high}}$",  # Bstophihigh_ARpar_err
    (
        "B_phi",
        "18_3_5",
    ): r"$\delta A_L^0(B_s\to\phi)_{\mathrm{high}}$",  # Bstophihigh_AL0_err
    (
        "B_phi",
        "18_3_6",
    ): r"$\delta A_R^0(B_s\to\phi)_{\mathrm{high}}$",  # Bstophihigh_AR0_err
    (
        "B_phi",
        "18_3_7",
    ): r"$\delta A_t(B_s\to\phi)_{\mathrm{high}}$",  # Bstophihigh_At_err
    (
        "B_phi",
        "18_3_8",
    ): r"$\delta A_S(B_s\to\phi)_{\mathrm{high}}$",  # Bstophihigh_AS_err
    ...
    (
        "Lb_L",
        "1_3_0",
    ): r"$a_{0}^{g_{\mathrm{pp}}}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a0_HO_gpp_LbLll
    (
        "Lb_L",
        "1_6_0",
    ): r"$a_{0}^{g_{\mathrm{pp}}}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a0_HO_gpp_LbLll
    (
        "Lb_L",
        "1_7_0",
    ): r"$a_{0}^{\tilde h_{\mathrm{pp}}}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a0_HO_htildepp_LbLll
    (
        "Lb_L",
        "1_8_0",
    ): r"$a_{0}^{\tilde h_{\mathrm{pp}}}(\Lambda_b\to\Lambda\ell\ell)_{\mathrm{HO}}$",  # a0_HO_htildepp_LbLll
