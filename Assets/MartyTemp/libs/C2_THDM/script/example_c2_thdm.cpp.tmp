...
using namespace c2_thdm;

int main(int argc, char** argv) {

	param_t param;
	std::string ParamFilePath = "/home/nfardeau/Hyperiso/Hyperiso/Assets/MartyTemp/libs/C2_THDM/bin/paramlist.csv";
	...
	setMu(Q_match);
	writeWilsonCoefficients("C2", C2(param), Q_match, path);
    return 0;
}
