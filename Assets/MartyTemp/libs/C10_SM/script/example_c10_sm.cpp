...
using namespace c10_sm;

int main(int argc, char** argv) {

	param_t param;
	std::string ParamFilePath = "/data/Hyperiso/Assets/MartyTemp/libs/C10_SM/bin/paramlist.csv";
	...
	std::string path = "/data/Hyperiso/Assets/MartyTemp/SM_wilson.csv";
	setMu(Q_match);
	writeWilsonCoefficients("C10", C10(param), Q_match, path);
    return 0;
}
