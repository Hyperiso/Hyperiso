...
using namespace c4_sm;

int main(int argc, char** argv) {

	param_t param;
	std::string ParamFilePath = "/home/cbmessaouda/Documents/hyperiso/Assets/MartyTemp/libs/C4_SM/bin/paramlist.csv";
	...
	setMu(Q_match);
	writeWilsonCoefficients("C4", C4(param), Q_match, path);
    return 0;
}
