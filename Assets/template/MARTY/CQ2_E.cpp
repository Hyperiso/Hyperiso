...
int calculate_CQ2e(Model &model, gauge::Type gauge) {
    ...
    Expr CQ2_e = getWilsonCoefficient(wil, Q2_mu);

    [[maybe_unused]] int sysres = system("rm -rf libs/CQ2_E_SM");
    mty::Library wilsonLib("CQ2_E_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CQ2_E", CQ2_e);
...
int main() {
    SM_Model sm;
    return calculate_CQ2e(sm, gauge::Type::Feynman);
}