...
int calculate_C_BS_5(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/C_BS_5_SM");
    mty::Library wilsonLib("C_BS_5_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("C_BS_5", C);
...
int main() {
    SM_Model sm;
    return calculate_C_BS_5(sm, gauge::Type::Feynman);
}