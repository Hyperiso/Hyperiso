...
int calculate_CT_SD_3(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CT_SD_3_SM");
    mty::Library wilsonLib("CT_SD_3_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CT_SD_3", C);
...
int main() {
    SM_Model sm;
    return calculate_CT_SD_3(sm, gauge::Type::Feynman);
}