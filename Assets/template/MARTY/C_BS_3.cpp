...
int calculate_C_BS_3(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/C_BS_3_SM");
    mty::Library wilsonLib("C_BS_3_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("C_BS_3", C);
...
int main() {
    SM_Model sm;
    return calculate_C_BS_3(sm, gauge::Type::Feynman);
}