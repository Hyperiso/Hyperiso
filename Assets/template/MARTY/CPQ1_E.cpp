...
int calculate_CPQ1e(Model &model, gauge::Type gauge) {
    ...
    Expr CQP1_e = getWilsonCoefficient(wil, QP1_mu);

    [[maybe_unused]] int sysres = system("rm -rf libs/CPQ1_E_SM");
    mty::Library wilsonLib("CPQ1_E_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CPQ1_E", CQP1_e);
...
int main() {
    SM_Model sm;
    return calculate_CPQ1e(sm, gauge::Type::Feynman);
}