...
int calculate_C_CU_2(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/C_CU_2_SM");
    mty::Library wilsonLib("C_CU_2_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("C_CU_2", C);
...
int main() {
    SM_Model sm;
    return calculate_C_CU_2(sm, gauge::Type::Feynman);
}