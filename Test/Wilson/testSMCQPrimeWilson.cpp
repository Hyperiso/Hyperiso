...
int main() {
    ...
    runTest("LO", loStrategy, root_file + "/Test/csv/sm/WilsonCoefficients_PRIMECQ_LO.csv", root_file + "/Test/csv/superiso/sm/WilsonCoefficients_PRIMECQ_LO.csv", "SM", tolerance, true);
