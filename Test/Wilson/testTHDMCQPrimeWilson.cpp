...
int main() {
    ...
    runTest("LO", loStrategy, root_file + "/Test/csv/thdm/WilsonCoefficients_PRIMECQ_LO.csv", root_file + "/Test/csv/superiso/thdm/WilsonCoefficients_PRIMECQ_LO.csv", "THDM", tolerance, true);
    // runTest("NLO", nloStrategy, root_file + "/Test/csv/thdm/WilsonCoefficients_PRIMECQ_NLO.csv", root_file + "/Test/csv/superiso/thdm/WilsonCoefficients_PRIMECQ_NLO.csv", "THDM",tolerance, true);
