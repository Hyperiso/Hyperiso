...
int main() {
    ...
    runTest("LO", root_file + "/Test/csv/thdm/WilsonCoefficients_PRIMECQ_LO.csv", root_file + "/Test/csv/superiso/thdm/WilsonCoefficients_PRIMECQ_LO.csv", "THDM", tolerance, true);
