...
int main() {
    ...
    writeCoefficientsToFile("NLO", root_file + "/Test/csv/susy/WilsonCoefficients_NLO.csv", nloStrategy, 81);
    writeCoefficientsToFile("LO", root_file + "/Test/csv/susy/WilsonCoefficients_LO.csv", loStrategy, 81);
    writeCoefficientsToFile("NNLO", root_file + "/Test/csv/susy/WilsonCoefficients_NNLO.csv", nnloStrategy, 81);
