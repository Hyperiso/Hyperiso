...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v4.1.19"
  WORKING_DIRECTORY "/home/nfardeau/Hyperiso/Hyperiso/ExternalIntegration/../ExternalIntegration/SOFTSUSY/src/SOFTSUSY"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v4.1.19" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v4.1.19")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/nfardeau/Hyperiso/Hyperiso/ExternalIntegration/../ExternalIntegration/SOFTSUSY/src/SOFTSUSY'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/nfardeau/Hyperiso/Hyperiso/ExternalIntegration/../ExternalIntegration/SOFTSUSY/src/SOFTSUSY'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
