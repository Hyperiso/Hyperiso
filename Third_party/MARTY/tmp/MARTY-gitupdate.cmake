...
execute_process(
  COMMAND "/usr/bin/git" show-ref "1.6-beta"
  WORKING_DIRECTORY "/home/nfardeau/Hyperiso/Hyperiso/Hyperiso/Hyperiso/core/src/ExternalIntegration/../../../../../Third_party/MARTY/src/MARTY"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("1.6-beta" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/1.6-beta")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/nfardeau/Hyperiso/Hyperiso/Hyperiso/Hyperiso/core/src/ExternalIntegration/../../../../../Third_party/MARTY/src/MARTY'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/nfardeau/Hyperiso/Hyperiso/Hyperiso/Hyperiso/core/src/ExternalIntegration/../../../../../Third_party/MARTY/src/MARTY'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
