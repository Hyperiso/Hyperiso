...
#include <complex.h>
// Modification: G. Uhlrich 20/06/22
//
// The following condition must be added because
// __float128 complex is not a valid type definition
// and __complex128 has to be used instead.
#if QUAD && QUADSIZE == 16
typedef __complex128 ComplexType;
#else
