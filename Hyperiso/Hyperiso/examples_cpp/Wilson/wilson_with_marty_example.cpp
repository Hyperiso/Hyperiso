...
int main() {
    ...
    config_hyp.mty_model_path = "input_files/marty_model/Zprime.h"; //Path to the MARTY model file. If relative path is used, the path start from the Assets folder.
