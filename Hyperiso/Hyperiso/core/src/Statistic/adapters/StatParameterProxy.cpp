...
scalar_t StatParameterProxy::operator()(const ParamId& pid, DataType d_type) { 
...
std::shared_ptr<Parameter> StatParameterProxy::get_parameter(const ParamId& pid) const{
