...
struct WilsonBuildConfig : public AbstractConfig {
    ...
    /**
     * @brief Build only the SM matching contribution.
     *
     * This is the symmetric diagnostic mode to @ref bsm_only.  It skips
     * construction of the configured target-model BSM group and guarantees
     * SM matching values only.  In a MARTY session, HYP_AS_SM_MARTY still
     * selects whether the SM is generated by MARTY or by the native HyperIso
     * backend.
     */
    bool sm_only {false};
