...
const std::map<Observables, LhaID>& observable_flha_mapping() {
    static const std::map<Observables, LhaID> m = {
        ...
        {BR_BS_MUMU_UNTAG,                  {531,   1,     2,  13,   -13     }},
        {BR_BD_MUMU,                        {511,   1,     2,  13,   -13     }},
        {BR_BU_TAU_NU,                      {521,   1,     2, -15,    16     }},
        {R_TAU_NU,                          {521,   9132,   2, -15,    16     }},
        {ISOSPIN_ASYMMETRY_B_KSTAR_GAMMA,   {521,   4,     2,  313,   22     }},
        {BR_B__KSTAR_GAMMA,                 {521,   1,     2,  313,   22     }},
        {BR_B_XS_GAMMA,                     {5,     1,     2,  3,     22     }},
        {BR_B__D_TAU_NU,                    {521,   1,     3,  421,  -15,  16}},
        {A_FB_B__D_TAU_NU,                  {521,   5,     3,  421,  -15,  16}},
        {P_TAU_B__D_TAU_NU,                 {521,   92015,  3,  421,  -15,  16}},
        {R_D,                               {521,   9132,   3,  421,  -15,  16}},
        {BR_B__DSTAR_TAU_NU,                {521,   1,     3,  423,  -15,  16}},
        {A_FB_B__DSTAR_TAU_NU,              {521,   5,     3,  423,  -15,  16}},
        {P_TAU_B__DSTAR_TAU_NU,             {521,   92015,  3,  423,  -15,  16}},
        {P_D_B__DSTAR_TAU_NU,               {521,   921423, 3,  423,  -15,  16}},
        {R_DSTAR,                           {521,   9132,   3,  423,  -15,  16}},
        {BR_B__Xs_mu_mu__LOW_Q2,            {5,     1,     3,  3,     13, -13}}, // TODO : Implement ee and remove binning from enum
        {BR_B__Xs_mu_mu__HIGH_Q2,           {5,     1,     3,  3,     13, -13}},
        {BR_B__Xs_tau_tau__HIGH_Q2,         {5,     1,     3,  3,     15, -15}},
        {DGAMMA_DQ2_B__KSTAR_L_L,           {521,   1,     3,  323,   13, -13}}, // TODO : Separate ll into ee, mumu, tautau and seperate B into B0 and B+. Merge Gamma and Gamma_bar into BR
        // {DGAMMA_BAR_DQ2_B__KSTAR_L_L, "dGamma_bar_dq2_B__K*_l_l"},
        {A_FB_B__KSTAR_L_L,                 {521,   5,     3,  323,   13, -13}},
        {Q0_A_FB_B__KSTAR_L_L,              {521,   50,    3,  323,   13, -13}},
        {A_CP_B__KSTAR_L_L,                 {521,   3,     3,  323,   13, -13}},      
        {F_L_B__KSTAR_L_L,                  {521,   931,    3,  323,   13, -13}},
        {F_T_B__KSTAR_L_L,                  {521,   932,    3,  323,   13, -13}},
        {A_T_1_B__KSTAR_L_L,                {521,   9411,   3,  323,   13, -13}},
        {A_T_2_B__KSTAR_L_L,                {521,   9412,   3,  323,   13, -13}},
        {A_T_3_B__KSTAR_L_L,                {521,   9413,   3,  323,   13, -13}},
        {A_T_4_B__KSTAR_L_L,                {521,   9414,   3,  323,   13, -13}},
        {A_T_5_B__KSTAR_L_L,                {521,   9415,   3,  323,   13, -13}},
        {A_T_RE_B__KSTAR_L_L,               {521,   9416,   3,  323,   13, -13}},
        {A_T_RE_CPV_B__KSTAR_L_L,           {521,  -9416,   3,  323,   13, -13}},
        {A_IM_B__KSTAR_L_L,                 {521,   942,    3,  323,   13, -13}},
        {ALPHA_K_B__KSTAR_L_L,              {521,   932,    3,  323,   13, -13}},
        {H_T_1_B__KSTAR_L_L,                {521,   9431,   3,  323,   13, -13}},
        {H_T_2_B__KSTAR_L_L,                {521,   9432,   3,  323,   13, -13}},
        {H_T_3_B__KSTAR_L_L,                {521,   9433,   3,  323,   13, -13}},
        {P_2_B__KSTAR_L_L,                  {521,   9512,   3,  323,   13, -13}},
        {P_3_B__KSTAR_L_L,                  {521,   9513,   3,  323,   13, -13}},
        {P_6_B__KSTAR_L_L,                  {521,   9516,   3,  323,   13, -13}},
        {P_8_B__KSTAR_L_L,                  {521,   9518,   3,  323,   13, -13}},
        {P_PRIME_4_B__KSTAR_L_L,            {521,   9524,   3,  323,   13, -13}},
        {P_PRIME_5_B__KSTAR_L_L,            {521,   9525,   3,  323,   13, -13}},
        {P_PRIME_6_B__KSTAR_L_L,            {521,   9526,   3,  323,   13, -13}},
        {P_PRIME_8_B__KSTAR_L_L,            {521,   9528,   3,  323,   13, -13}},
        {S_3_B__KSTAR_L_L,                  {521,   9533,   3,  323,   13, -13}},
        {S_4_B__KSTAR_L_L,                  {521,   9534,   3,  323,   13, -13}},
        {S_5_B__KSTAR_L_L,                  {521,   9535,   3,  323,   13, -13}},
        {S_6C_B__KSTAR_L_L,                 {521,   9536,   3,  323,   13, -13}},
        {S_7_B__KSTAR_L_L,                  {521,   9537,   3,  323,   13, -13}},
        {S_8_B__KSTAR_L_L,                  {521,   9538,   3,  323,   13, -13}},
        {S_9_B__KSTAR_L_L,                  {521,   9539,   3,  323,   13, -13}},
        {A_3_B__KSTAR_L_L,                  {521,  -9533,   3,  323,   13, -13}},
        {A_4_B__KSTAR_L_L,                  {521,  -9534,   3,  323,   13, -13}},
        {A_5_B__KSTAR_L_L,                  {521,  -9535,   3,  323,   13, -13}},
        {A_6S_B__KSTAR_L_L,                 {521,  -9536,   3,  323,   13, -13}},
        {A_7_B__KSTAR_L_L,                  {521,  -9537,   3,  323,   13, -13}},
        {A_8_B__KSTAR_L_L,                  {521,  -9538,   3,  323,   13, -13}},
        {A_9_B__KSTAR_L_L,                  {521,  -9539,   3,  323,   13, -13}},
        {P_1_CPV_B__KSTAR_L_L,              {521,  -9511,   3,  323,   13, -13}},
        {P_2_CPV_B__KSTAR_L_L,              {521,  -9512,   3,  323,   13, -13}},
        {P_3_CPV_B__KSTAR_L_L,              {521,  -9513,   3,  323,   13, -13}},
        {P_PRIME_4_CPV_B__KSTAR_L_L,        {521,  -9524,   3,  323,   13, -13}},
        {P_PRIME_5_CPV_B__KSTAR_L_L,        {521,  -9525,   3,  323,   13, -13}},
        {P_PRIME_6_CPV_B__KSTAR_L_L,        {521,  -9526,   3,  323,   13, -13}},
        {P_PRIME_8_CPV_B__KSTAR_L_L,        {521,  -9528,   3,  323,   13, -13}},
        {DGAMMA_DQ2_BS__PHI_L_L,            {531,   1,     3,  333,   13, -13}}, // TODO : Separate ll into ee, mumu, tautau. Merge Gamma and Gamma_bar into BR
        // {DGAMMA_BAR_DQ2_BS__PHI_L_L, "dGamma_bar_dq2_Bs__phi_l_l"},
        {A_FB_CPV_BS__PHI_L_L,              {531,  -5,     3,  333,   13, -13}},
        {F_L_BS_PHI_L_L,                    {531,   931,    3,  333,   13, -13}},
        {A_T_2_BS_PHI_L_L,                  {531,   9412,   3,  333,   13, -13}},
        {A_T_RE_CPV_BS_PHI_L_L,             {531,  -9416,   3,  333,   13, -13}},
        {A_T_IM_CPV_BS_PHI_L_L,             {531,  -9417,   3,  333,   13, -13}},
        {P_PRIME_4_BS_PHI_L_L,              {531,   9524,   3,  333,   13, -13}},
        {P_PRIME_6_BS_PHI_L_L,              {531,   9526,   3,  333,   13, -13}},
        {S_2S_BS_PHI_L_L,                   {531,   9532,   3,  333,   13, -13}},
        {S_3_BS_PHI_L_L,                    {531,   9533,   3,  333,   13, -13}},
        {S_4_BS_PHI_L_L,                    {531,   9534,   3,  333,   13, -13}},
        {S_7_BS_PHI_L_L,                    {531,   9537,   3,  333,   13, -13}},
        {A_5_BS_PHI_L_L,                    {531,  -9535,   3,  333,   13, -13}},
        {A_6C_BS_PHI_L_L,                   {531,  -9536,   3,  333,   13, -13}},
        {A_8_BS_PHI_L_L,                    {531,  -9538,   3,  333,   13, -13}},
        {A_9_BS_PHI_L_L,                    {531,  -9539,   3,  333,   13, -13}},
        {P_2_CPV_BS_PHI_L_L,                {531,  -9512,   3,  333,   13, -13}},
        {P_3_CPV_BS_PHI_L_L,                {531,  -9513,   3,  333,   13, -13}},
        {P_PRIME_5_CPV_BS_PHI_L_L,          {531,  -9525,   3,  333,   13, -13}},
        {P_PRIME_8_CPV_BS_PHI_L_L,          {531,  -9528,   3,  333,   13, -13}},
        // {Q_8M_BS_PHI_L_L, "Q_8m_Bs__phi_l_l"}, TODO
        // {Q_8P_BS_PHI_L_L, "Q_8p_CPV_Bs__phi_l_l"}, TODO
        // {Q_9_BS_PHI_L_L, "Q_9_CPV_Bs__phi_l_l"}, TODO
        {DGAMMA_DQ2_B__K_L_L,               {521,   1,      3,  321,   13, -13}}, // TODO : Separate ll into ee, mumu, tautau and seperate B into B0 and B+. Merge Gamma and Gamma_bar into BR
        {A_FB_B__K_L_L,                     {521,   5,      3,  321,   13, -13}},
        {F_H_B__K_L_L,                      {521,   934,    3,  321,   13, -13}}, 
        {DGAMMA_DQ2_CP_AVG_LAMBDA_B__LAMBDA_L_L, {5122,  1,     3,  3122,  13, -13}}, // TODO : Separate ll into ee, mumu, tautau. Change Gamma to BR
        {A_FB_L_LAMBDA_B__LAMBDA_L_L,       {5122,  51,    3,  3122,  13, -13}},
        {A_FB_H_LAMBDA_B__LAMBDA_L_L,       {5122,  52,    3,  3122,  13, -13}},
        {A_FB_LH_LAMBDA_B__LAMBDA_L_L,      {5122,  53,    3,  3122,  13, -13}},
        {F_L_LAMBDA_B__LAMBDA_L_L,          {5122,  931,    3,  3122,  13, -13}},
        {F_T_LAMBDA_B__LAMBDA_L_L,          {5122,  932,    3,  3122,  13, -13}},
        {PHI_D,                             {511,   71,    1, -511}},
