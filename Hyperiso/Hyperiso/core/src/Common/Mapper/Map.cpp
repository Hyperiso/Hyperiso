...
const std::map<WGroup, std::string>& group_mapping() {
    static const std::map<WGroup, std::string> m = {
        ...
        {WGroup::BCC_bc, "BcChargedCurrentCoefficients"},
        {WGroup::BCC_bu, "BuChargedCurrentCoefficients"},
        {WGroup::BCC_cs, "DsChargedCurrentCoefficients"},
        {WGroup::BCC_cd, "DdChargedCurrentCoefficients"},
        {WGroup::BCC_su, "KuChargedCurrentCoefficients"},
