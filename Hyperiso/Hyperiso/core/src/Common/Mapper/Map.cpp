...
const std::map<WGroup, std::string>& group_mapping() {
    static const std::map<WGroup, std::string> m = {
        ...
        {WGroup::CC_du, "PIuChargedCurrentCoefficients"},
...
const std::map<WCoef, std::string>& wcoef_mapping() {
    static const std::map<WCoef, std::string> m = {
        ...
        {WCoef::C_V1_du, "C_V1_du"}, {WCoef::C_V2_du, "C_V2_du"}, {WCoef::C_S1_du, "C_S1_du"}, {WCoef::C_S2_du, "C_S2_du"}, {WCoef::C_T_du, "C_T_du"},
...
const std::map<WCoef, std::pair<int, int>>& wcoef_flha_mapping() {
    static const std::map<WCoef, std::pair<int, int>> m = {
        ...
        {WCoef::C_V1_du, {4051516, 11111}}, {WCoef::C_V2_du, {4051516, 22222}},
        {WCoef::C_S1_du, {4051516, 33333}}, {WCoef::C_S2_du, {4051516, 44444}}, {WCoef::C_T_du, {4051516, 55555}},
