...
double C8t2mt(double x)
{
	...
	else return -0.614093-0.897491*w-0.0349242*w*w+0.0679089*pow(w,3.)+0.0796552*pow(w,4.)
	+0.0722587 * pow(w,5.0) + 0.0613235*pow(w,6.)+0.0509632*pow(w,7.)+0.0421555*pow(w,8.) + 0.0349448 * pow(w,9.)
	+0.0291171 * pow(w,10.) + 0.0244182 * pow(w,11.) + 0.0206190 * pow(w,12.) + 0.0175317 * pow(w, 13) 
	+0.0150070 * pow(w,14.) + 0.0129285 * pow(w,15.) + 0.0112057 * pow(w,16.);
}
