...
public:
    C_V1_cs_THDM() : WilsonCoefficient("C_V1_cs_THDM", GroupMapper::str(WGroup::BCC_cs) + "_MATCH") {}
...
public:
    C_V2_cs_THDM() : WilsonCoefficient("C_V2_cs_THDM", GroupMapper::str(WGroup::BCC_cs) + "_MATCH") {}
...
public:
    C_T_cs_THDM() : WilsonCoefficient("C_T_cs_THDM", GroupMapper::str(WGroup::BCC_cs) + "_MATCH") {}
...
public:
    C_V1_cd_THDM() : WilsonCoefficient("C_V1_cd_THDM", GroupMapper::str(WGroup::BCC_cd) + "_MATCH") {}
...
public:
    C_V2_cd_THDM() : WilsonCoefficient("C_V2_cd_THDM", GroupMapper::str(WGroup::BCC_cd) + "_MATCH") {}
...
public:
    C_T_cd_THDM() : WilsonCoefficient("C_T_cd_THDM", GroupMapper::str(WGroup::BCC_cd) + "_MATCH") {}
