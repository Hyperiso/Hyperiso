...
public:
    C_V1_su_SUSY() : WilsonCoefficient("C_V1_su_SUSY", GroupMapper::str(WGroup::BCC_su) + "_MATCH") {}
...
public:
    C_V2_su_SUSY() : WilsonCoefficient("C_V2_su_SUSY", GroupMapper::str(WGroup::BCC_su) + "_MATCH") {}
...
public:
    C_T_su_SUSY() : WilsonCoefficient("C_T_su_SUSY", GroupMapper::str(WGroup::BCC_su) + "_MATCH") {}
