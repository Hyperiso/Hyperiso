...
void BCoefficientGroup::set_base_1_LO() {
    ...
    auto func = [] (const std::unordered_map<std::string, std::shared_ptr<Block>>& src, std::shared_ptr<DependentBlock> dep_block) {
        ...
        for (size_t k = 0; k < 10; k++) {
            ...
            dep_block->store_or_assign(1, std::make_shared<Parameter>(pid, Ci_run[k], 0., 0.));
        }
    };
...
void BCoefficientGroup::set_base_2_LO() {
    LOG_INFO("In BCoefficientGroup::set_base_2_LO");

    std::unordered_map<ParameterType, std::vector<std::string>> src = {
        {ParameterType::WILSON, {"B_MATCH", "WPARAM_RUN_SM", "V_MATRIX"}},
    };
...
void BCoefficientGroup::set_base_1_NLO() {
    LOG_INFO("In BCoefficientGroup::set_base_1_NLO");

    std::unordered_map<ParameterType, std::vector<std::string>> src = {
        {ParameterType::WILSON, {"B_MATCH", "WPARAM_RUN_SM", "U_MATRIX"}},
    };
    ...
    auto func = [] (const std::unordered_map<std::string, std::shared_ptr<Block>>& src, std::shared_ptr<DependentBlock> dep_block) {
        ...
        for (size_t k = 0; k < 10; k++) {
            ...
            dep_block->store_or_assign(1, std::make_shared<Parameter>(pid, eta * Ci_run[k], 0., 0.));
        }
    };
...
void BCoefficientGroup::set_base_2_NLO() {
    LOG_INFO("In BCoefficientGroup::set_base_2_NLO");
...
void BCoefficientGroup::set_base_1_NNLO() {
    LOG_INFO("In BCoefficientGroup::set_base_1_NNLO");
    ...
    auto func = [] (const std::unordered_map<std::string, std::shared_ptr<Block>>& src, std::shared_ptr<DependentBlock> dep_block) {
        ...
        for (size_t k = 0; k < 10; k++) {
            ParamId pid {ParameterType::WILSON, "B_HADRONIC", WCoefMapper::flha_full(ids[k], QCDOrder::NLO, false)};
            dep_block->store_or_assign(1, std::make_shared<Parameter>(pid, eta_sq * Ci_run[k], 0., 0.));
        }
    };
...
void BPrimeCoefficientGroup::set_base_1_LO() {
    ...
    auto func = [] (const std::unordered_map<std::string, std::shared_ptr<Block>>& src, std::shared_ptr<DependentBlock> dep_block) {
        ...
        for (size_t k = 0; k < ids.size(); k++) {
            ...
            dep_block->store_or_assign(1, std::make_shared<Parameter>(pid, CPk_run, 0., 0.));;
        }
    };
