...
scalar_t BDstarlnuDecay::C_V1() {
    return w_proxy->getFM(WGroup::BCC, WCoef::C_V1, QCDOrder::LO);
}

scalar_t BDstarlnuDecay::C_V2() {
    return w_proxy->getFM(WGroup::BCC, WCoef::C_V2, QCDOrder::LO);
}
...
void BDstarlnuDecay::build_op_tree() {
    ...
    roots.emplace(ObservableMapper::to_id(Observables::BR_B__DSTAR_TAU_NU), BR);
    ...
    roots.emplace(ObservableMapper::to_id(Observables::R_DSTAR), R_D);
    ...
    roots.emplace(ObservableMapper::to_id(Observables::A_FB_B__DSTAR_TAU_NU), A_FB);
    ...
    roots.emplace(ObservableMapper::to_id(Observables::P_TAU_B__DSTAR_TAU_NU), P_tau);
    ...
    roots.emplace(ObservableMapper::to_id(Observables::P_D_B__DSTAR_TAU_NU), P_D);
}
