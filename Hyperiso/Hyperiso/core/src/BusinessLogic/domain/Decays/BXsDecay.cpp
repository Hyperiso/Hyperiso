...
void BXsDecay::build_op_tree() {
    ...
    auto wilson_had = this->get_wilson_node();
    auto wilson_match = this->get_wilson_node(ScaleType::MATCHING);
    ...
    c7_em->addChildren({eta, c8_em, c2_em, wilson_match});
    ...
    eps_em->addChildren({inv_alpha_em, alpha_s_mu_b, c7_em, k_sl, wilson_had}); 
    ...
    k_t->addChildren({eta, wilson_match}); 
    ...
    p_21->addChildren({k_11, k_12, k_17, k_18, k_22, k_27, k_28, k_37, k_47, k_48, k_57, k_67, k_77, k_78, k_88, wilson_had});
    ...
    p_32->addChildren({k_11, k_12, k_17, k_18, k_22, k_27, k_28, k_37, k_47, k_48, k_57, k_67, k_77, k_78, k_88, wilson_had});
    ...
    p_22_rem_z0->addChildren({k_11_rem_z0, k_12_rem_z0, k_17_rem_z0, k_18_rem_z0, k_22_rem_z0, k_27_rem_z0, k_28_rem_z0, k_77_rem_z0, k_78_rem_z0, k_88_rem_z0, wilson_had});
    ...
    p_22_rem_z1->addChildren({k_11_rem_z1, k_12_rem_z1, k_17_rem_z1, k_18_rem_z1, k_22_rem_z1, k_27_rem_z1, k_28_rem_z1, k_77_rem_z1, k_78_rem_z1, k_88_rem_z1, wilson_had});
