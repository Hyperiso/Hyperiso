...
void init_common(py::module &m) {
    ...
    py::enum_<Observables>(m, "Observables")
        ...
        .value("BR_B__K_NU_NU", Observables::BR_B__K_NU_NU)
        .value("BR_B0__KS_NU_NU", Observables::BR_B0__KS_NU_NU)
        .value("BR_B__KSTAR_NU_NU", Observables::BR_B__KSTAR_NU_NU)
        .value("BR_B0__KSTAR0_NU_NU", Observables::BR_B0__KSTAR0_NU_NU)
        ...
        .value("A_FS_D", Observables::A_FS_D)
        .value("A_FS_S", Observables::A_FS_S)
        ...
        .value("DELTA_M_D", Observables::DELTA_M_D)
    ...
    py::enum_<Decays>(m, "Decays")
        ...
        .value("B__K_nu_nu", Decays::B__K_nu_nu)
        .value("B__Kstar_nu_nu", Decays::B__Kstar_nu_nu)
    ...
    py::enum_<WCoef>(m, "WCoef")
        ...
        .value("CNU_L_EE", WCoef::CNU_L_EE)
        .value("CNU_R_EE", WCoef::CNU_R_EE)
        .value("CNU_L_EMU", WCoef::CNU_L_EMU)
        .value("CNU_R_EMU", WCoef::CNU_R_EMU)
        .value("CNU_L_ETAU", WCoef::CNU_L_ETAU)
        .value("CNU_R_ETAU", WCoef::CNU_R_ETAU)
        .value("CNU_L_MUE", WCoef::CNU_L_MUE)
        .value("CNU_R_MUE", WCoef::CNU_R_MUE)
        .value("CNU_L_MUMU", WCoef::CNU_L_MUMU)
        .value("CNU_R_MUMU", WCoef::CNU_R_MUMU)
        .value("CNU_L_MUTAU", WCoef::CNU_L_MUTAU)
        .value("CNU_R_MUTAU", WCoef::CNU_R_MUTAU)
        .value("CNU_L_TAUE", WCoef::CNU_L_TAUE)
        .value("CNU_R_TAUE", WCoef::CNU_R_TAUE)
        .value("CNU_L_TAUMU", WCoef::CNU_L_TAUMU)
