...
void init_common(py::module &m) {
    ...
    py::enum_<Observables>(m, "Observables")
        ...
        .value("DGAMMA_BAR_DQ2_B0__KSTAR0_E_E", Observables::DGAMMA_BAR_DQ2_B0__KSTAR0_E_E)
        ...
        .value("DGAMMA_BAR_DQ2_B0__KSTAR0_MU_MU", Observables::DGAMMA_BAR_DQ2_B0__KSTAR0_MU_MU)
        ...
        .value("DGAMMA_BAR_DQ2_B0__KSTAR0_TAU_TAU", Observables::DGAMMA_BAR_DQ2_B0__KSTAR0_TAU_TAU)
