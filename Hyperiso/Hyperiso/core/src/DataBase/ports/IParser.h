...
/**
 * @file IParser.h
 * @brief Abstract interface for (de)serializing data as DBNode trees.
 *
 * An IParser provides a common API to:
 *   - parse a textual representation into a DBNode hierarchy,
 *   - serialize a DBNode hierarchy to a file,
 *   - read a DBNode hierarchy back from a file.
 *
 ...
 *   - parse(): build a DBNode tree from an in-memory string,
 *   - writeToFile(): serialize a DBNode tree to a file,
 *   - readFromFile(): read a DBNode tree from a file (and typically
 *     delegate to parse()).
 */
class IParser {
    public:
        ...
        /**
         * @brief Parses an input string into a DBNode hierarchy.
         *
         ...
         * @return Shared pointer to the root DBNode of the parsed tree.
         *
        ...
        /**
         * @brief Serializes a DBNode hierarchy to a file.
         *
        ...
        /**
         * @brief Reads and parses a DBNode hierarchy from a file.
         *
