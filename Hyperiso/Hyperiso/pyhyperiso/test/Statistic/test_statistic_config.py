...
def test_fit_parameter_sensitivity_defaults_to_cpp():
    ...
    assert cpp.fit_parameter_sensitivity_scale_floor == pytest.approx(1e-12)
...
def test_fit_parameter_sensitivity_custom_values_to_cpp():
    cfg = AdvancedStatisticConfig(
        ...
        fit_parameter_sensitivity_scale_floor=4e-13,
    ...
    assert cpp.fit_parameter_sensitivity_scale_floor == pytest.approx(4e-13)
