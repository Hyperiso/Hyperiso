...
int calculate_CNU_L_TAUTAU(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_L_TAUTAU_SM");
    mty::Library wilsonLib("CNU_L_TAUTAU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_L_TAUTAU", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_L_TAUTAU(sm, gauge::Type::Feynman);
}
