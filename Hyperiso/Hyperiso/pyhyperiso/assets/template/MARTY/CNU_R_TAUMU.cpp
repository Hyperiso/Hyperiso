...
int calculate_CNU_R_TAUMU(Model &model, gauge::Type gauge) {
    ...
    const std::vector<Insertion> hyperiso_bnunu_insertions = {
        ...
        Outgoing("nu_tau"), Outgoing(AntiPart("nu_mu"))
    };
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_R_TAUMU_SM");
    mty::Library wilsonLib("CNU_R_TAUMU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_R_TAUMU", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_R_TAUMU(sm, gauge::Type::Feynman);
}
