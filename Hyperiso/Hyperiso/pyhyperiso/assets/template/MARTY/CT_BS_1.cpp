...
int calculate_CT_BS_1(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CT_BS_1_SM");
    mty::Library wilsonLib("CT_BS_1_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CT_BS_1", C);
...
int main() {
    SM_Model sm;
    return calculate_CT_BS_1(sm, gauge::Type::Feynman);
}