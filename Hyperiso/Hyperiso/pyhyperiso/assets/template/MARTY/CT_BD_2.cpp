...
int calculate_CT_BD_2(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CT_BD_2_SM");
    mty::Library wilsonLib("CT_BD_2_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CT_BD_2", C);
...
int main() {
    SM_Model sm;
    return calculate_CT_BD_2(sm, gauge::Type::Feynman);
}