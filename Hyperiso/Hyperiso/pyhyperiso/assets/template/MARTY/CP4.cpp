...
int calculate_C4(Model &model, gauge::Type gauge) {
    ...
    auto O4_u = dimension6Operator(model, wil_u, DiracCoupling::VR, DiracCoupling::V, {"C", ColorCoupling::Generator}, {0, 2, 1, 3});
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CP4_SM");
    mty::Library wilsonLib("CP4_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CP4", C4_u + C4_c);
