...
int calculate_C_CU_5(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/C_CU_5_SM");
    mty::Library wilsonLib("C_CU_5_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("C_CU_5", C);
...
int main() {
    SM_Model sm;
    return calculate_C_CU_5(sm, gauge::Type::Feynman);
}