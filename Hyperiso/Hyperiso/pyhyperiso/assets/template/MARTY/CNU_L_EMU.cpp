...
int calculate_CNU_L_EMU(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_L_EMU_SM");
    mty::Library wilsonLib("CNU_L_EMU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_L_EMU", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_L_EMU(sm, gauge::Type::Feynman);
}
