...
int calculate_CNU_R_MUE(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_R_MUE_SM");
    mty::Library wilsonLib("CNU_R_MUE_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_R_MUE", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_R_MUE(sm, gauge::Type::Feynman);
}
