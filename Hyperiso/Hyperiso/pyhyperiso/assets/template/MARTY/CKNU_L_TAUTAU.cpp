...
int calculate_CKNU_L_TAUTAU(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CKNU_L_TAUTAU_SM");
    mty::Library wilsonLib("CKNU_L_TAUTAU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CKNU_L_TAUTAU", C);
...
int main() {
    SM_Model sm;
    return calculate_CKNU_L_TAUTAU(sm, gauge::Type::Feynman);
}
