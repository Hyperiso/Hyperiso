...
int calculate_CNU_R_TAUE(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_R_TAUE_SM");
    mty::Library wilsonLib("CNU_R_TAUE_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_R_TAUE", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_R_TAUE(sm, gauge::Type::Feynman);
}
