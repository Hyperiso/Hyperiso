...
int calculate_CNU_R_EE(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_R_EE_SM");
    mty::Library wilsonLib("CNU_R_EE_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_R_EE", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_R_EE(sm, gauge::Type::Feynman);
}
