...
int calculate_CNU_R_MUTAU(Model &model, gauge::Type gauge) {
    ...
    const std::vector<Insertion> hyperiso_bnunu_insertions = {
        ...
        Outgoing("nu_mu"), Outgoing(AntiPart("nu_tau"))
    };
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_R_MUTAU_SM");
    mty::Library wilsonLib("CNU_R_MUTAU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_R_MUTAU", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_R_MUTAU(sm, gauge::Type::Feynman);
}
