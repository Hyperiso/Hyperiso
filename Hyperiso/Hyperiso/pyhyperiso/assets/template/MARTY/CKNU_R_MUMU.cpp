...
int calculate_CKNU_R_MUMU(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CKNU_R_MUMU_SM");
    mty::Library wilsonLib("CKNU_R_MUMU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CKNU_R_MUMU", C);
...
int main() {
    SM_Model sm;
    return calculate_CKNU_R_MUMU(sm, gauge::Type::Feynman);
}
