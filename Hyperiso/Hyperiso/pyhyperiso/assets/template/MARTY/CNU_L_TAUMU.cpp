...
int calculate_CNU_L_TAUMU(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_L_TAUMU_SM");
    mty::Library wilsonLib("CNU_L_TAUMU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_L_TAUMU", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_L_TAUMU(sm, gauge::Type::Feynman);
}
