...
int calculate_CNU_L_MUTAU(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_L_MUTAU_SM");
    mty::Library wilsonLib("CNU_L_MUTAU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_L_MUTAU", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_L_MUTAU(sm, gauge::Type::Feynman);
}
