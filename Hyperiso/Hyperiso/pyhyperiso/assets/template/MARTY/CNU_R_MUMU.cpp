...
int calculate_CNU_R_MUMU(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_R_MUMU_SM");
    mty::Library wilsonLib("CNU_R_MUMU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_R_MUMU", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_R_MUMU(sm, gauge::Type::Feynman);
}
