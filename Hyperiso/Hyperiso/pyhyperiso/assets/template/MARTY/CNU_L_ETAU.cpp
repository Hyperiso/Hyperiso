...
int calculate_CNU_L_ETAU(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_L_ETAU_SM");
    mty::Library wilsonLib("CNU_L_ETAU_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_L_ETAU", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_L_ETAU(sm, gauge::Type::Feynman);
}
