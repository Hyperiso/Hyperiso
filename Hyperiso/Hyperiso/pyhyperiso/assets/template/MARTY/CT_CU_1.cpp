...
int calculate_CT_CU_1(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CT_CU_1_SM");
    mty::Library wilsonLib("CT_CU_1_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CT_CU_1", C);
...
int main() {
    SM_Model sm;
    return calculate_CT_CU_1(sm, gauge::Type::Feynman);
}