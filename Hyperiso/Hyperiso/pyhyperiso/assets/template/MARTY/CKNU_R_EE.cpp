...
int calculate_CKNU_R_EE(Model &model, gauge::Type gauge) {
    ...
    const std::vector<Insertion> hyperiso_knunu_insertions = {
        ...
        Outgoing("nu_e"), Outgoing(AntiPart("nu_e"))
    };
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CKNU_R_EE_SM");
    mty::Library wilsonLib("CKNU_R_EE_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CKNU_R_EE", C);
...
int main() {
    SM_Model sm;
    return calculate_CKNU_R_EE(sm, gauge::Type::Feynman);
}
