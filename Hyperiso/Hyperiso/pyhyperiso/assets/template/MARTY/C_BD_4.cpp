...
int calculate_C_BD_4(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/C_BD_4_SM");
    mty::Library wilsonLib("C_BD_4_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("C_BD_4", C);
...
int main() {
    SM_Model sm;
    return calculate_C_BD_4(sm, gauge::Type::Feynman);
}