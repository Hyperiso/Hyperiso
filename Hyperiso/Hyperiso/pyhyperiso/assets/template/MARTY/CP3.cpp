...
int calculate_C3(Model &model, gauge::Type gauge) {
    ...
    auto O3_u = dimension6Operator(model, wil_u, DiracCoupling::VR, DiracCoupling::V, {0, 2, 1, 3});
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CP3_SM");
    mty::Library wilsonLib("CP3_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CP3", C3_u + C3_c);
