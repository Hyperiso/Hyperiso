...
int calculate_CKNU_L_EE(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CKNU_L_EE_SM");
    mty::Library wilsonLib("CKNU_L_EE_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CKNU_L_EE", C);
...
int main() {
    SM_Model sm;
    return calculate_CKNU_L_EE(sm, gauge::Type::Feynman);
}
