...
int calculate_CNU_L_EE(Model &model, gauge::Type gauge) {
    ...
    [[maybe_unused]] int sysres = system("rm -rf libs/CNU_L_EE_SM");
    mty::Library wilsonLib("CNU_L_EE_SM", "libs");
    wilsonLib.cleanExistingSources();
    wilsonLib.addFunction("CNU_L_EE", C);
...
int main() {
    SM_Model sm;
    return calculate_CNU_L_EE(sm, gauge::Type::Feynman);
}
