...
from pyhyperiso.Core import HyperisoConfig, HyperisoMaster, ParameterProvider, CorrelationProvider, APIAdapter, APIPath
...
if __name__ == "__main__":
    ...
    print(cp.correlation_from_paramid(ParamId(ParameterType.DECAY, "B_K", "1_1_0"), ParamId(ParameterType.DECAY, "B_K", "1_1_1"), CorrelationType.STAT))
    ...
    print(cp.correlation_from_observable(Observables.F_L_B0__KSTAR0_MU_MU, Observables.P_1_B0__KSTAR0_MU_MU, CorrelationType.STAT, "CMS"))
