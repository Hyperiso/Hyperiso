...
if __name__ == "__main__":
    ...
    print(
        "Value before the changes of the Electroweak scale within Hyperiso :",
        param_provider.get_by_pid(ParamId(ParameterType.WILSON, "EW_SCALE", 1)),
    )
    ...
    print(
        "Value after the changes of the Electroweak scale within Hyperiso :",
        param_provider.get_by_pid(ParamId(ParameterType.WILSON, "EW_SCALE", 1)),
    )
