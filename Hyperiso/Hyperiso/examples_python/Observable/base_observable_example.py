from pyhyperiso.Common import Model, Observables, QCDOrder, Decays, BinnedObservableId
...
if __name__ == "__main__":
    ...
    interface.add_binned_observable(
        BinnedObservableId(Observables.F_L_B0__KSTAR0_MU_MU, {1.1, 6.0}), QCDOrder.NNLO
    )
    ...
    print(
        interface.compute_observable(Observables.F_L_B0__KSTAR0_MU_MU)
