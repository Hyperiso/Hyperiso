from pyhyperiso.Common import Model, QCDOrder, ParameterType, Decays, ParamId

from pyhyperiso.Core import HyperisoConfig, HyperisoMaster

from pyhyperiso.Observable import ObservableInterface

from pyhyperiso.Statistic import StatisticInterface, StatisticConfig, ContourOptions
...
if __name__ == "__main__":
    ...
    result_contour = si.compute_confidence_contour(
        ParamId(ParameterType.FLAVOR, "FCONST", [511, 1]),
        ParamId(ParameterType.FLAVOR, "FCONST", [531, 1]),
        1,
        [-0.5, 0.5, -0.5, 0.5],
